 ...
 *
 * ----------	---------	-------------------------------------	--------------------------
 * 2013-02-18	guofeizhi	Solve kernel compile error		FEIXUN_SOLVE_KERNEL_COMPILE_ISSUE_GUOFEIZHI_001
 *
 */
...
u16 show_len;
u16 total_len;
u8 got_file_flag = 0;   // 0xF0: bin file ready, 0x0F: cfg file ready, 0x00: gtp_default_FW auto update
u8 searching_file = 0;
...
#define FL_UPDATE_PATH              "/data/GT950_1010.bin"
#define FL_UPDATE_PATH_SD           "/data/GT950_1010.bin"  //"/sdcard/_fl_update_.bin"
//for clk cal
