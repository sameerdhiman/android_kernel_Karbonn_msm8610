...
#include <mach/fdv.h>
#define S5K4E1_I2C_ADDR 0x6e
#define DESC "S5K4E1_camera at 0x6e"
#endif


#define s5k4e1_SENSOR_NAME "s5k4e1a"
...
static const struct of_device_id s5k4e1_dt_match[] = {
	{.compatible = "shinetech,s5k4e1a", .data = &s5k4e1_s_ctrl},
	{}
};
